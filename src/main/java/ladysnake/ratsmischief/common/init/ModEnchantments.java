...
public interface ModEnchantments {
	...
	Enchantment RAT_CURSE = createEnchantment("rat_curse", new RatCurseEnchantment(Rarity.EPIC, EquipmentSlot.values()));

	@SuppressWarnings("SameParameterValue")
	private static Enchantment createEnchantment(String name, RatCurseEnchantment entity) {
