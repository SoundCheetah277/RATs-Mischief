...
public class EnchantmentHelperMixin {
	...
	private static boolean mischief$letTheEnchantDecide(EnchantmentEffectTarget enchantmentTarget, Item item, Operation<Boolean> original, @Share("storedEnchantment") LocalRef<Enchantment> storedEnchantment) {
